...
const environments = {
  ...
  staging: {
    name: 'Staging',
    frontend: {
      VITE_API_SERVICE_URL: 'https://api-staging.LynxLake.com',
      VITE_SOCKET_SERVICE_URL: 'https://socket-staging.LynxLake.com',
      VITE_EXECUTION_SERVICE_URL: 'https://execution-staging.LynxLake.com',
      VITE_GOOGLE_CLIENT_ID: 'your_google_client_id_here',
      NODE_ENV: 'staging'
    },
    apiService: {
      API_PORT: '5000',
      NODE_ENV: 'staging',
      POSTGRES_URL: 'postgresql://username:password@staging-db:5432/LynxLake_db',
      JWT_SECRET_KEY: 'your_jwt_secret_key_here',
      JWT_TIMEOUT: '24h',
      SALT_ROUNDS: '10',
      USER_EMAIL: 'your_email@gmail.com',
      ...
      GOOGLE_CLIENT_SECRET: 'your_google_client_secret',
      ABSTRACT_API_KEY: 'your_abstract_api_key',
      FRONTEND_URL: 'https://staging.LynxLake.com',
      SOCKET_SERVICE_URL: 'https://socket-staging.LynxLake.com',
      EXECUTION_SERVICE_URL: 'https://execution-staging.LynxLake.com'
    },
    socketService: {
      SOCKET_PORT: '5001',
      NODE_ENV: 'staging',
      POSTGRES_URL: 'postgresql://username:password@staging-db:5432/LynxLake_db',
      FRONTEND_URL: 'https://staging.LynxLake.com',
      API_SERVICE_URL: 'https://api-staging.LynxLake.com',
      EXECUTION_SERVICE_URL: 'https://execution-staging.LynxLake.com',
      SOCKET_CORS_ORIGIN: 'https://staging.LynxLake.com',
      SOCKET_TRANSPORTS: 'websocket,polling'
    },
    executionService: {
      EXECUTION_PORT: '5002',
  ...
  production: {
    name: 'Production',
    frontend: {
      VITE_API_SERVICE_URL: 'https://api.LynxLake.com',
      VITE_SOCKET_SERVICE_URL: 'https://socket.LynxLake.com',
      VITE_EXECUTION_SERVICE_URL: 'https://execution.LynxLake.com',
      VITE_GOOGLE_CLIENT_ID: 'your_google_client_id_here',
      NODE_ENV: 'production'
    },
    apiService: {
      API_PORT: '5000',
      NODE_ENV: 'production',
      POSTGRES_URL: 'postgresql://username:password@prod-db:5432/LynxLake_db',
      JWT_SECRET_KEY: 'your_jwt_secret_key_here',
      JWT_TIMEOUT: '24h',
      SALT_ROUNDS: '10',
      USER_EMAIL: 'your_email@gmail.com',
      ...
      GOOGLE_CLIENT_SECRET: 'your_google_client_secret',
      ABSTRACT_API_KEY: 'your_abstract_api_key',
      FRONTEND_URL: 'https://LynxLake.com',
      SOCKET_SERVICE_URL: 'https://socket.LynxLake.com',
      EXECUTION_SERVICE_URL: 'https://execution.LynxLake.com'
    },
    socketService: {
      SOCKET_PORT: '5001',
      NODE_ENV: 'production',
      POSTGRES_URL: 'postgresql://username:password@prod-db:5432/LynxLake_db',
      FRONTEND_URL: 'https://LynxLake.com',
      API_SERVICE_URL: 'https://api.LynxLake.com',
      EXECUTION_SERVICE_URL: 'https://execution.LynxLake.com',
      SOCKET_CORS_ORIGIN: 'https://LynxLake.com',
      SOCKET_TRANSPORTS: 'websocket,polling'
    },
    executionService: {
      EXECUTION_PORT: '5002',
